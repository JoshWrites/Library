...
3. Sample VRAM 10x at 1 sec intervals: `for i in $(seq 1 10); do rocm-smi --showmeminfo vram -d 0 --json; sleep 1; done`.
...
3. Repeat 3x per model size to capture cold-vs-pipeline-cache-warm
   variance.
